...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除会话“{name}”及其全部消息记录，此操作无法撤销。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes the session “{name}” and all its message history. This cannot be undone.',
