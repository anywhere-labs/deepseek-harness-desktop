...
export const zh = {
  ...
  'message.stopped': '已停止',
  'message.edit': '编辑此消息',
  'message.edit.aria': '编辑消息内容',
  'message.edit.save': '保存',
  'message.edit.cancel': '取消',
  'error.edit.session-not-found': '会话不可用，请稍后重试',
  'error.edit.message-not-found': '消息已不存在，可能已被修改或压缩',
  'error.edit.message-too-long': '修改后的内容过长，请精简后重试',
...
export const en = {
  ...
  'message.edit.aria': 'Edit message content',
  'message.edit.save': 'Save',
  'message.edit.cancel': 'Cancel',
  'error.edit.session-not-found': 'Session unavailable, try again later',
  'error.edit.message-not-found': 'The message no longer exists; it may have been edited or compacted away',
  'error.edit.message-too-long': 'The edited content is too long, shorten it and retry',
  'error.raw': '{code}: {message}',
