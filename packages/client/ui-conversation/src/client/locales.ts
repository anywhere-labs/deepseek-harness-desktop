...
export const zh = {
  ...
  'produced.open.succeeded': '已将 {name} 交给系统打开；若未弹出窗口或选择软件对话框，说明该文件类型已有默认程序但未能打开此路径，请更换默认程序或手动打开 {path}',
  'produced.open.failed': '打开 {name} 失败：{reason}',
...
export const en = {
  ...
  'produced.open.succeeded': 'Handed {name} to the OS to open; if no window or app-chooser appeared, the file type has a default app that could not open this path — change the default app or open {path} manually',
  'produced.open.failed': 'Failed to open {name}: {reason}',
