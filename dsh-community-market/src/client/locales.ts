export const zh = {
  ...
  autoUpdate: '自动更新插件',
  confirmAutoUpdateTitle: '启用自动更新',
  confirmAutoUpdateBody: '未来版本会在启动时自动安装，完成后 Desktop 会自动重启，并以你的用户权限运行新代码。此授权覆盖当前和今后通过插件市场管理的插件。',
  enableAutoUpdate: '同意并启用',
  uninstall: '卸载',
  disable: '禁用',
  enable: '启用',
  ...
  confirmUpdateAllTitle: '确认全部更新',
  confirmInstallBody: '请确认 DSH Desktop 验证的 npm 包、版本和目标配置。',
  confirmUpdateBody: '更新将替换当前精确版本，并由 Desktop 启动恢复机制保护。',
  confirmUpdateAllBody: '将一次更新所有符合条件的市场托管插件。',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  autoUpdate: 'Automatically update plugins',
  confirmAutoUpdateTitle: 'Enable automatic updates',
  confirmAutoUpdateBody: 'Future releases will install automatically at startup, then Desktop will restart and run the new code with your user permissions. This approval covers current and future plugins managed by Plugin Market.',
  enableAutoUpdate: 'Accept and enable',
  uninstall: 'Uninstall',
  disable: 'Disable',
  enable: 'Enable',
  ...
  confirmUpdateAllTitle: 'Confirm all updates',
  confirmInstallBody: 'Review the npm package, version, and target profile verified by DSH Desktop.',
  confirmUpdateBody: 'The exact installed version will be replaced under Desktop startup recovery protection.',
  confirmUpdateAllBody: 'All eligible Plugin Market managed plugins will be updated together.',
  ...
  updateAllComplete: 'All plugins updated',
