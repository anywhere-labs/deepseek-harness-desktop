export const zh = {
  ...
  installableTruncated: '目录源仅返回了部分插件（实际共 {total} 个），可安装列表可能不完整。',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  installableTruncated: 'The catalog source returned only part of its plugins ({total} total); this list may be incomplete.',
