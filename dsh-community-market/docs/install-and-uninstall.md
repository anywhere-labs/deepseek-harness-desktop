...
- its declared DSH/Cordis dependencies are compatible with the Desktop runtime based on DSH `0.1.1-rc.1`, and its declared Node engine accepts the bundled Node.js runtime;
