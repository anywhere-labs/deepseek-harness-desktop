...
- 对唯一已选来源执行一次完整扫描；标准来源的网络 page 服从 manifest 和 Schema 最大值 100，经过审核的 1024Store adapter 只读取一次当前发布页；
