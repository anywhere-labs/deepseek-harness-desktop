...
Provider 卡片会显示连通状态、本地累计 Token、支持时的账户余额或套餐余量，以及最近更新时间。心跳按钮会立即测试端点，统计按钮会打开当前 Provider 的详细视图；原有编辑和删除操作保持不变。
...
插件固定到经过验证的提交 `32db0da4d418a469f625b84582bcf9d93f64fd4f`，便于安装包复现和依赖审计。
