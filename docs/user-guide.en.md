...
- **Local models do not appear**: confirm Ollama or LM Studio is listening on `127.0.0.1`, then scan and apply them under **Worker pack > Local models**. AI Buddy does not ship API keys.
