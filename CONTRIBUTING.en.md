...
- Desktop code lives in `dsh-plugin-desktop/`; the market shell lives in `dsh-community-market/` and is currently documentation-only and not loadable. Both owned packages use the outer Yarn workspace.
