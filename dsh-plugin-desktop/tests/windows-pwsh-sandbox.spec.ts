...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\AI Buddy\\AI Buddy.exe',
  upstreamRunner: 'C:\\Program Files\\AI Buddy\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\AI Buddy\\resources\\app.asar\\desktop-runner.js',
}
