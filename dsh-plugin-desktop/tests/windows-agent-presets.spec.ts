...
describe('Windows agent preset guard', () => {
  it('hides minimal, falls back for defaults, and preserves legacy resolution', async () => {
    ...
    await expect(presets.resolve('code')).resolves.toMatchObject({ id: 'code' })
  })

  it('rejects selecting the hidden minimal preset for a new composition', async () => {
